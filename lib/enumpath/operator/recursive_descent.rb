...
module Enumpath
  module Operator
    ...
    class RecursiveDescent < Base
      ...
      # @yieldparam enum [Enumerable] {enum} as-is for the enumerable itself, or the direct enumerable member for each
      #   direct enumerable member
      # @yieldparam resolved_path [Array] {resolved_path} as-is for the enumerable itself, or {resolved_path} plus the
      #   key for each direct enumerable member
